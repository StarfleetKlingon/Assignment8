    /*
File:  www.github.com/StarfleetKlingon/Assignment8/a5.js
 ...
 $(document).ready(function(){
  ...
  messages : {
    x_low: {
      ...
      min: "Low value for x axis must be larger than or equal to -10.",
      max: "Low value for x axis must be smaller than or equal to 10."
    },
    x_high: {
      required: "Please input high value for x axis.",
      min: "High value for x axis must be larger than or equal to -10.",
      max: "High value for x axis must be smaller than or equal to 10."
    },
    y_low: {
      required: "Please input low value for y axis.",
      min: "Low value for y axis must be larger than or equal to -10.",
      max: "Low value for y axis must be smaller than or equal to 10."
    },
    y_high: {
      required: "Please input high value for y axis.",
      min: "High value for y axis must be larger than or equal to -10.",
      max: "High value for y axis must be smaller than or equal to 10."
    },
  },   //end of messages
